...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres',
        'PASSWORD': 'F3AoAmWH62GFfFDRejXBh*TVnoJPECMCZHM',
        'HOST': 'db',
        'PORT': 5432,
    }
}
...
# Set who the default is

AUTH_USER_MODEL = "sptApp.Student"

ACCOUNT_USER_MODEL_USERNAME_FIELD = "username"

DJANGO_SETTINGS_MODULE = "sptApp.settings"
...
# as declared in NginX conf, it must match /code/static/
STATIC_ROOT = '/static/'
