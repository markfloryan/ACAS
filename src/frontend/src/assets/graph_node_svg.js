...
export const generate_svg = (svg,title,grade,lock) => {
  let color = perc2color(grade);
  let status = '';
  if (lock) {
    status = 'Locked';
    color = 'none';
        ...
        <g id="main-content" transform="translate(262.000000, 128.000000)">
          <g id="content" transform="translate(46.000000, 23.000000)">
            <g id="class" transform="translate(488.000000, 220.000000)">
              ...
              <text id="0%" font-family="Helvetica" font-size="18" font-weight="normal" letter-spacing="3.3" fill="#000000">
                <tspan x="18.6921875" y="113">${ grade }%</tspan>
              </text>
              <text id="Not-unlocked" font-family="Helvetica" font-size="14" font-weight="normal" letter-spacing="3.3" fill="#000000">
                <tspan x="145" y="113">${ status }</tspan>
              </text>
