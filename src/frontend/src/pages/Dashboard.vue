<template>
  <!-- Dashboard.vue
    ...
    or select a class from the sidebar.
  ...
  <div class="dashboard">
    ...
    <h2 v-if="this.profile.is_professor != 1" class="title">Welcome{{ userFullName }}</h2>
...
export default {
  ...
  created() {
    ...
    if (this.profile.first_name || this.profile.last_name) {
      ...
      this.userFullName = '!'; // If no names, just say 'Welcome!' 
    }
  },
};
</script>
