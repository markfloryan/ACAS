    ...
    createCourse() {
      ...
      axios
        ...
        .then(res => {
          ...
          axios
            .post(`${API_URL}/courses/`, courseData, { headers: { Authorization: `Bearer ${this.profile.id_token}` } })
            .then(data => {
              axios
                .get(`${API_URL}/courses/`, { headers: { Authorization: `Bearer ${this.profile.id_token}` } })
                .then(data => {
                  ...
                  const createRelationshipData = {
                    course: pk,
                    student: profile.auth.profile.pk,
                  };
                  axios
                    .post(`${API_URL}/student/course/`, createRelationshipData, { headers: { Authorization: `Bearer ${this.profile.id_token}` } })
                    .then(response => {
