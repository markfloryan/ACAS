<template>
    <div class="container">
        ...
        <p>This upload will create or update existing grades. CSV Schema: username, assignment_name, assignment_name, ...</p>
        <label>
  ...
  */
  ...
  methods: {
    ...
    submitAssignmentFile(){
      ...
      //let formattedURL = `${API_URL}/courseGradesUpload/${this.pk}`;
      ...
      axios
        .post( `${API_URL}/courseGradesUpload/${coursePK}`,
          formData,
          {
            headers: {
